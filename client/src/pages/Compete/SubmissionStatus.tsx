...
const SubmissionStatus = () => {
  ...
  const totalPassedCases = testCases.filter((value) => value.status === 'Passed').length;
  ...
  if (testCases.length === 0) {
    return <EmptySectionPlaceholder message="Run or submit your code to view the status" />;
  }
