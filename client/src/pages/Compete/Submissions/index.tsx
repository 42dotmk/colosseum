...
const SubmissionsTab = () => {
  ...
  const submissions = [
    {
      language: 'TypeScript',
      code: ["const message: string = 'Hello, World!';", 'console.log(message);'],
      status: 'Passed',
      testCases: [
        {
          input:
    ...
    {
      language: 'Java',
      code: ['String message = "Hello, World!";', 'System.out.println(message);'],
      status: 'Failed',
      testCases: [
        {
          input:
  ...
  return (
    ...
    >
      ...
      <Grid item xs={6} height="inherit">
        <Paper>
          <SubmissionPreview language={activeSubmission.language} code={activeSubmission.code} />
        </Paper>
      </Grid>
    </Grid>
  );
